...
class SeDRAM(DRAMStandard):
    ...
    timing_constraints = [
        ...
        # Channel
        # ============================================================
        # RAS <-> RAS (ACT precede +1, ACT follow -1 cancel out automatically)
        ...
        # Generator auto-adds +1 for ACT preceding; no manual +1 needed
        ...
        # Generator auto-subtracts 1 for ACT following; no manual -1 needed
        TimingConstraint(level="Channel", preceding=["REFpb", "RFMpb"], following=["ACT"], latency="nRREFD"),

        # Compensate for generator's automatic ACT offset (cpp wants no adjustment here)
        TimingConstraint(level="Channel", preceding=["ACT"], following=["PREab"], latency="nRAS - 1"),
        TimingConstraint(level="Channel", preceding=["PREab"], following=["ACT"], latency="nRP + 1"),

        TimingConstraint(level="Channel", preceding=["ACT"], following=["REFab", "RFMab"], latency="nRC - 1"),
        ...
        # Split: ACT branch needs +1 to counter the generator's -1; REFpb/RFMpb branch needs none
        TimingConstraint(level="Channel", preceding=["REFab", "RFMab"], following=["ACT"], latency="nRFC + 1"),
        TimingConstraint(level="Channel", preceding=["REFab", "RFMab"], following=["REFpb", "RFMpb"], latency="nRFC"),
        ...
        # ACT precede +1, ACT follow -1 cancel out automatically
        TimingConstraint(level="Bank", preceding=["ACT"], following=["ACT"], latency="nRC"),
        # Compensate for generator's automatic +1 (cpp wants no adjustment here)
        TimingConstraint(level="Bank", preceding=["ACT"], following=["RD", "RDA"], latency="nRCDRD - 1"),
        TimingConstraint(level="Bank", preceding=["ACT"], following=["WR", "WRA"], latency="nRCDWR - 1"),
        TimingConstraint(level="Bank", preceding=["ACT"], following=["PREpb"], latency="nRAS - 1"),
        TimingConstraint(level="Bank", preceding=["PREpb"], following=["ACT"], latency="nRP + 1"),
        ...
        # Split: ACT branch needs +1 to counter the generator's -1; REFpb/RFMpb branch needs none
        TimingConstraint(level="Bank", preceding=["RDA"], following=["ACT"], latency="nRTPL + nRP + 1"),
        TimingConstraint(level="Bank", preceding=["RDA"], following=["REFpb", "RFMpb"], latency="nRTPL + nRP"),
        TimingConstraint(level="Bank", preceding=["WRA"], following=["ACT"], latency="nCWL + nBL + nWR + nRP + 1"),
        TimingConstraint(level="Bank", preceding=["WRA"], following=["REFpb", "RFMpb"], latency="nCWL + nBL + nWR + nRP"),
    ]
